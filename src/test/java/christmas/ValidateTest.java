...
//		menuEqualsTestData = Util.parseInputDataToEngName(menuEqualsTestData);
//		menuNotEqualsTestData = Util.parseInputDataToEngName(menuNotEqualsTestData);
		assertThrows(IllegalArgumentException.class, ()->Validate.checkEqualsMenu(Util.parseInputDataToEngName(menuNotEqualsTestData)));
		assertDoesNotThrow(()->Validate.checkEqualsMenu(Util.parseInputDataToEngName(menuEqualsTestData)));
	}
